...
**How to apply:** Verrouiller tous les paiements sélectionnés dans une transaction, vérifier qu’ils sont encore `en_attente`, débiter une seule fois la source choisie, puis mettre à jour chaque paiement avec la même référence de lot. Les fiches destinées à la station doivent reprendre les montants des paiements en attente et regrouper les lignes par station. En cas d’échec ou de concurrence, annuler toute l’opération.