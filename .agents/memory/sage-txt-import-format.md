...
La devise est indiquée dans l’en-tête (`#DEV XOF`) et ne doit pas être répétée comme huitième colonne.

**Why:** Sage signale une incohérence dès la première ligne de données lorsqu’il reçoit le compte avant la pièce ou une colonne devise supplémentaire.
