...
export async function getProgrammes(req: Request, res: Response): Promise<void> {
  ...
  catch (err) { req.log.error({ err }, "getProgrammes"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function postProgramme(req: Request, res: Response): Promise<void> {
  ...
  } catch (err) { req.log.error({ err }, "postProgramme"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function putProgramme(req: Request, res: Response): Promise<void> {
  try {
    ...
    res.json(row);
  } catch (err) { req.log.error({ err }, "putProgramme"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function deleteProgramme(req: Request, res: Response): Promise<void> {
  try {
    ...
    res.json({ ok: true });
  } catch (err) { req.log.error({ err }, "deleteProgramme"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function getSessions(req: Request, res: Response): Promise<void> {
  ...
  } catch (err) { req.log.error({ err }, "getSessions"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function postSession(req: Request, res: Response): Promise<void> {
  ...
  } catch (err) { req.log.error({ err }, "postSession"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function putSession(req: Request, res: Response): Promise<void> {
  try {
    ...
    res.json(row);
  } catch (err) { req.log.error({ err }, "putSession"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function postInscrire(req: Request, res: Response): Promise<void> {
  try {
    ...
    req.log.error({ err }, "postInscrire"); res.status(500).json({ erreur: apiError(err) });
  }
}
...
export async function getInscrits(req: Request, res: Response): Promise<void> {
  ...
  } catch (err) { req.log.error({ err }, "getInscrits"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function deleteInscription(req: Request, res: Response): Promise<void> {
  try {
    ...
    res.json({ ok: true });
  } catch (err) { req.log.error({ err }, "deleteInscription"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function putPresences(req: Request, res: Response): Promise<void> {
  ...
  } catch (err) { req.log.error({ err }, "putPresences"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function postConvoquer(req: Request, res: Response): Promise<void> {
  ...
  } catch (err) { req.log.error({ err }, "postConvoquer"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function postRappel(req: Request, res: Response): Promise<void> {
  ...
  } catch (err) { req.log.error({ err }, "postRappel"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function postAttestations(req: Request, res: Response): Promise<void> {
  ...
  } catch (err) { req.log.error({ err }, "postAttestations"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function getAttestation(req: Request, res: Response): Promise<void> {
  try {
    ...
    res.send(buffer);
  } catch (err) { req.log.error({ err }, "getAttestation"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function getListeAttestations(req: Request, res: Response): Promise<void> {
  ...
  } catch (err) { req.log.error({ err }, "getListeAttestations"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function getStatsMembre(req: Request, res: Response): Promise<void> {
  ...
  } catch (err) { req.log.error({ err }, "getStatsMembre"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function getStats(req: Request, res: Response): Promise<void> {
  ...
  catch (err) { req.log.error({ err }, "getStats formations"); res.status(500).json({ erreur: apiError(err) }); }
}
...
export async function getExportExcel(req: Request, res: Response): Promise<void> {
  try {
    ...
    req.log.error({ err }, "getExportExcel"); res.status(500).json({ erreur: apiError(err) });
  }
}
...
export async function getExportPdf(req: Request, res: Response): Promise<void> {
  try {
    ...
    if ((err as { code?: string }).code === "NOT_FOUND") { res.status(404).json({ erreur: "Session introuvable" }); return; }
    req.log.error({ err }, "getExportPdf"); res.status(500).json({ erreur: apiError(err) });
  }
}
