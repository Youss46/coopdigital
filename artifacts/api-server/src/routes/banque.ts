...
router.get("/banque/caisses",              checkPermission("banque", "voir"),            ctrl.getCaisses);
...
router.post("/banque/:id/virement-caisse", checkPermission("banque", "enregistrer_mvt"), ctrl.postVirementCaisse);
