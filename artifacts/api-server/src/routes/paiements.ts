...
import { listPaiements, validerPaiement, validerLotPaiementsCarburant, rejeterPaiement, annulerRejetPaiement, statsPaiements } from "../controllers/paiementsController";
...
router.post("/paiements/:id/annuler-rejet", authMiddleware, checkPermission("paiements", "annuler_rejet"), auditMiddleware("paiements", "UPDATE", { entiteIdParam: "id", entiteType: "paiement_reouverture" }), annulerRejetPaiement);
