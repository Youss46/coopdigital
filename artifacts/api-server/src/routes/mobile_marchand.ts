...
router.get("/mobile-marchand/caisses",             checkPermission("mobile_marchand", "voir"),           ctrl.getCaissesCentrales);
...
router.post("/mobile-marchand/:id/virement-caisse",checkPermission("mobile_marchand", "enregistrer_mvt"),ctrl.postVirementCaisse);
