          ...
          showCertification ? (
            <div className="t-form">
              ...
              <div style={{ marginBottom: 20 }}>
                <div className="t-label" style={{ marginBottom: 10 }}>Type de cacao</div>
              ...
              <button
                type="button"
                className="t-btn t-btn--ghost"
                onClick={() => { setFournisseur(null); setShowCertification(false); setStep(1); }}
              >
