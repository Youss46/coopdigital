...
export const NAV_ITEMS: NavItemConfig[] = [
  ...
  { href: "/exportateurs",           label: "Exportateurs",              roles: ["pca","directeur","comptable","responsable_tracabilite","auditeur"],                category: "Commerce" },
  ...
  { href: "/cheques",                label: "Chèques",                   roles: ["pca","directeur","comptable","caissier","auditeur"],                         category: "Finances", showChequesBadge: true },
