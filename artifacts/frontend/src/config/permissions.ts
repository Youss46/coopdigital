...
export const PERMISSIONS: Record<string, Record<string, string[]>> = {
  ...
  livraisons: {
    ...
    // dédiés (terrain/session), jamais depuis la page Livraisons.
    creer:     [],
  ...
  reporting: {
    ...
    generer_recu:               ["pca", "directeur", "comptable", "caissier", "delegue", "magasinier"],
  ...
  sacherie: {
    ...
    gerer_types: ["pca", "directeur", "magasinier", "sacherie"],
    mouvement:   ["pca", "directeur", "magasinier", "sacherie"],
    ajuster:     ["pca", "directeur", "magasinier", "sacherie"],
  },
