      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <div className="relative flex-1 sm:flex-none">
            ...
            <input
              className="w-full sm:w-48 border border-gray-200 rounded-lg pl-9 pr-3 py-2 text-sm focus:outline-none focus:ring-1 bg-white"
        ...
        {onglets.map((o) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 text-sm font-medium border-b-2 whitespace-nowrap shrink-0 transition-colors -mb-px ${
                onglet === o.id
