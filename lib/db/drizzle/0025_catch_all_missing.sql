-- Migration 0025 : tables skippées par le baseline (0019-0023)
-- Le baseline de ci-migrate était fixé à 0023, donc migrations 0019-0023
-- ont été skippées alors que certaines tables n'existaient pas encore sur Railway.
