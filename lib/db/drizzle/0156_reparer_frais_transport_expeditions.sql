ALTER TABLE expeditions
  ...
  ADD COLUMN IF NOT EXISTS frais_transport_statut VARCHAR(20) DEFAULT 'non_paye',
...
ALTER TABLE expeditions
  ALTER COLUMN frais_transport_statut SET DEFAULT 'non_paye',
  ALTER COLUMN frais_transport_statut SET NOT NULL;
