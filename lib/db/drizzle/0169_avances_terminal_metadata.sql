-- Termine les avances sans supprimer leur créance ni leur historique.
ALTER TABLE "avances"
...
DO $$ BEGIN
  ALTER TABLE "avances"
    ADD CONSTRAINT "avances_statut_action_user_id_users_id_fk"
...
DO $$ BEGIN
  ALTER TABLE "avances"
    ADD CONSTRAINT "avances_terminal_metadata_check"
    CHECK (
