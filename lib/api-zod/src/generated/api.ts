...
export const GetMembresResponse = zod.object({
  ...
  "categorieMembre": zod.string().nullish().describe('Catégorie métier du membre, notamment membre délégué de localités.'),
...
export const CreateLivraisonBody = zod.object({
  ...
  "prixUnitaireFcfa": zod.number(),
  "dateLivraison": zod.string(),
  "modePaiement": zod.enum(['orange_money', 'mtn_momo', 'especes', 'wave', 'cheque', 'differe']).optional(),
...
export const GetUsersResponseItem = zod.object({
  ...
  "role": zod.enum(['pca', 'directeur', 'comptable', 'caissier', 'magasinier', 'responsable_tracabilite', 'agent_terrain', 'auditeur', 'responsable_rh', 'sacherie']),
  "actif": zod.boolean(),
  "cooperativeId": zod.number().nullish(),
  "createdAt": zod.coerce.date(),
...
export const CreateUserBody = zod.object({
  ...
  "telephone": zod.string().optional(),
  "role": zod.enum(['pca', 'directeur', 'comptable', 'caissier', 'magasinier', 'responsable_tracabilite', 'agent_terrain', 'auditeur', 'delegue', 'peseur', 'responsable_rh', 'sacherie']),
