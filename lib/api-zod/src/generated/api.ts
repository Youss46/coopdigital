...
export const GetUsersResponseItem = zod.object({
  ...
  "role": zod.enum(['pca', 'directeur', 'comptable', 'caissier', 'magasinier', 'responsable_tracabilite', 'agent_terrain', 'auditeur', 'responsable_rh']),
  "actif": zod.boolean(),
  "cooperativeId": zod.number().nullish(),
  "createdAt": zod.coerce.date(),
...
export const CreateUserBody = zod.object({
  ...
  "telephone": zod.string().optional(),
  "role": zod.enum(['pca', 'directeur', 'comptable', 'caissier', 'magasinier', 'responsable_tracabilite', 'agent_terrain', 'auditeur', 'delegue', 'peseur', 'responsable_rh']),
